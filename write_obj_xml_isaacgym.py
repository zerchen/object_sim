...
for object_name in os.listdir(target_category):
    xml_file_path = os.path.join("objects", target_category, f"{object_name}_isaacgym.xml")
    ...
    with open(xml_file_path, 'w') as f:
        ...
        f.writelines(f"        <body name=\"object\" pos=\"0.0 0.0 {z_str}\">\n")
        f.writelines(f"            <body name=\"object_entity\">\n")
